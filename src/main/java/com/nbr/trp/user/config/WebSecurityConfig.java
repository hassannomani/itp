...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http)
        ...
        http.cors().and().csrf().disable().exceptionHandling()
                ...
                .requestMatchers("/api/v1/certificate/check/**").permitAll()
                .requestMatchers("/api/v1/certificate/get/**").permitAll()
                ...
                .requestMatchers("/api/v1/common/taxesbarassoc").permitAll()
